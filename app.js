  ...
  (error, result) => {
    if (!error && result && result.event === "success") {
      ...
      var settings = {
        ...
        crossDomain: true,
        url:
          "https://faceplusplus-faceplusplus.p.rapidapi.com/facepp/v3/detect?return_attributes=gender%2Cage%2Csmiling%2Cfacequality%2Cblur%2Cbeauty%2Cemotion%2Cfacequality%2Cethnicity%2Cskinstatus&image_url=" +
          imageURL,
        method: "POST",
        headers: {
          "x-rapidapi-host": "faceplusplus-faceplusplus.p.rapidapi.com",
          "x-rapidapi-key":
            "436517c447msh97cde90ad4dc1e8p10f577jsn59a377f7b533",
      ...
      $.ajax(settings).done(function(response) {
        ...
        var skinHealth = Math.floor(
          response.faces[0].attributes.skinstatus.health
        );
...
function fortuneTelling() {
  ...
  var fortuneURL =
    "http://fortunecookieapi.herokuapp.com/v1/fortunes?limit=1&skip=" +
    randomNumber +
    "&page=" +
    randomNumber;
